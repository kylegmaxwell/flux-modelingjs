...
function colorToArray(colorName) {
    ...
    if (colorName.indexOf('#') !== -1 && colorName.length === 7) {
        r = Number('0x'+colorName.substr(1,2))/255;
        g = Number('0x'+colorName.substr(3,2))/255;
        b = Number('0x'+colorName.substr(5,2))/255;
    } else {
        var colorhex = colorKeywords[colorName];
